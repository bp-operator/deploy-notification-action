...
function getRepository() {
    ...
    if (!repository)
        throw ReferenceError('Failed To Get GITHUB_REPOSITORY in workflow environment');
    return repository;
}
function getToken() {
...
function getMilestoneNumber(version, page = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (result.length === perPage) {
            return yield getMilestoneNumber(version, page + 1);
        }
        return null;
    });
}
...
function getMilestoneIssues(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (milestoneIssues == null)
            throw ReferenceError(`Failed To Get milestone issues milestone number:${milestoneNumber}`);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, slack_1.sendToSlack)(milestoneIssues, version);
        }
        catch (error) {
...
const node_fetch_1 = __importDefault(__nccwpck_require__(467));
function getPayload(issues, version) {
...
function sendToSlack(issues, version) {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, node_fetch_1.default)(getSlackUrl(), {
            ...
            body: JSON.stringify(getPayload(issues, version))
        });
    });
}
